...
<nav class="sidebar">
        ...
        <div class="menu-bar">
            <div class="menu" id="menu">
                <ul class="menu-links">
                    ...
                    <li class="nav-link">
                        <a href="water_tracker.php" class="active">
    ...
    <section class="home">
        <div class="text">Water Tracker</div>
...
<div class="tracker-container">
    <div class="water-intake-container">
        <h1 class="title"> Let's Stay Hydrated!</h1>
        <img src="images/water_cartoon.png" alt="Water Glass" class="water-glass">
        <form action="log_intake.php" method="post" class="intake-form">
            <label for="cups">How many glasses of water have you drank today? 🤔</label>
            <select id="cups" name="cups" required>
            ...
            <input type="submit" value="Log Intake" class="log-button">
        </form>
    </div>
    <div class="intake-history-container">
        <h2 class="history-title">Your Hydration Journey</h2>
        <div class="intake-history">
            <?php include 'display_intake.php'; ?>
        </div>
    </div>
</div>

...
// Define the challenge name
$challengeName = "Sugar Rush Riddles";
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    if (isset($_POST['username']) && isset($_POST['score'])) {
        ...
        try {
            ...
            header("Location: riddles_leaderboard.php");
            exit();
            }
...
<body>
    <div class="quiz-new-container">
        <div id="end" class="flex-center flex-column">
            ...
            <form id="scoreForm" action="sugar_rush_riddles_end.php" method="post">
